package br.com.academiagumga.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"br.com.academiagumga", "gumga.framework"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.academiagumga", "gumga.framework"})
...
//        config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/junitspring?zeroDateTimeBehavior=convertToNull");
...
//        config.addDataSourceProperty("password", "senha");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("gumga.framework.domain","br.com.academiagumga");
