define(function(require) {
  ...
  require('app/modules/gumgacustomfield/module');
    require('app/modules/contacorrente/module');
    require('app/modules/transacao/module');
  //FIMREQUIRE
    ...
    var template = [
      ...
      $stateProvider
        ...
        data: {
            ...
            url: '/contacorrente',
            templateUrl: 'app/modules/contacorrente/views/base.html'
        })
        ...
        data: {
            ...
            url: '/transacao',
            templateUrl: 'app/modules/transacao/views/base.html'
        })
