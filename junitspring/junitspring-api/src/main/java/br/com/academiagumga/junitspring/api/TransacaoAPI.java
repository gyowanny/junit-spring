...
import  br.com.academiagumga.junitspring.application.service.TransacaoService;
...
public class TransacaoAPI extends GumgaAPI<Transacao, Long> {

    @Autowired
    public TransacaoAPI(GumgaService<Transacao, Long> service) {
        super(service);
    }
